...
const MetricCard = ({ title, value, subtitle, valueClassName }: MetricCardProps) => (
  <Card>
    ...
    <CardContent>
      <div className={`text-3xl font-bold ${valueClassName || 'text-foreground'}`}>{value}</div>
...
export const DashboardPage = () => {
  ...
  return (
    <div className="space-y-8">
      ...
      <div>
        <h2 className="mb-4 text-xl font-semibold text-foreground">Inventory Health</h2>
        <div className="grid gap-6 md:grid-cols-2">
          {inventoryLoading ? (
      ...
      <div>
        <h2 className="mb-4 text-xl font-semibold text-foreground">Top Performers</h2>
        <div className="grid gap-6 md:grid-cols-2">
          {detailedDataLoading ? (
          ...
          <div>
            <h2 className="mb-4 text-xl font-semibold text-foreground">Trends</h2>
            <Card>
              <CardHeader>
