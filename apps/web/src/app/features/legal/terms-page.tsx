      ...
      <div className="mx-auto max-w-3xl rounded-lg border border bg-card p-8 shadow-sm">
        ...
        <div className="prose prose-slate max-w-none space-y-6">
          ...
          <section>
            ...
            <p className="text-foreground leading-relaxed mb-3">As a user of Electric Abacus, you agree to:</p>
            <ul className="list-disc list-inside text-foreground space-y-1 ml-4">
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mb-3">4. Data and Privacy</h2>
            <p className="text-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mb-3">5. Service Modifications</h2>
            <p className="text-foreground leading-relaxed">
